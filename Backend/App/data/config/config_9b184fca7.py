...
llm_cfg1 = dict(type="chatglm", apikey="f118b48f5559e4e3ccdd3a5c30712aef.c5uSVYS1k4PGoNGC",name="chatglm", llm_intro="")
qw = LLM_base.build(llm_cfg1)
config1 = ExampleConfig(qw, qw)

llm_cfg2 = dict(type="chatGpt", apikey="f118b48f5559e4e3ccdd3a5c30712aef.c5uSVYS1k4PGoNGC", name="chatGpt", llm_intro="这是出自openai的")
